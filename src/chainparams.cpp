...
{
    const char* pszTimestamp = "Pakistan and Turkey Turkesha. Pakistan and Turkey Zindabad 12/25/2020";
    const CScript genesisOutputScript = CScript() << ParseHex("099584710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
...
//work left
        ...
        genesis = CreateGenesisBlock(1608844733, 2002113765, 0x1e0ffff0, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x7f4418cf2214bdc7284726e52f58d6b13bbb74cd0cc35a5a328ac0a513aa31b4"));
        assert(genesis.hashMerkleRoot == uint256S("0x096e69df96ded7cb6c75387b21ebfcc2d028b9409c611c564ae02e4c9fec1090"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        vSeeds.push_back(CDNSSeedData("46.101.212.181", "46.101.212.181", true));
        //vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed.thrasher.io", true));
        //vSeeds.push_back(CDNSSeedData("bitesaxtools.com", "dnsseed.bitesaxtools.com"));
        //vSeeds.push_back(CDNSSeedData("bitesaxpool.org", "dnsseed.bitesaxpool.org"));
        ...
        checkpointData = (CCheckpointData) {
            ...
            (  0, uint256S("0x7f4418cf2214bdc7284726e52f58d6b13bbb74cd0cc35a5a328ac0a513aa31b4"))
        ...
        chainTxData = ChainTxData{
            ...
            1608844733, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1608844733, 376395, 0x1e0ffff0, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xb843709228c5acd94ad0ac775821a470d80d464862e820fa3a4fb320a0b25250"));
        assert(genesis.hashMerkleRoot == uint256S("0x096e69df96ded7cb6c75387b21ebfcc2d028b9409c611c564ae02e4c9fec1090"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.push_back(CDNSSeedData("46.101.212.181", "46.101.212.181"));
       // vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b.bitesax.loshan.co.uk", true));
       // vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed-testnet.thrasher.io", true));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            ( 0, uint256S("0xb843709228c5acd94ad0ac775821a470d80d464862e820fa3a4fb320a0b25250")),
        };
...
public:
    CRegTestParams() {
       ...
       // consensus.BIP34Height = 100000000; // BIP34 has not activated on regtest (far in the future so block v1 are not rejected in tests)
        ...
        genesis = CreateGenesisBlock(1608844733, 0, 0x207fffff, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x5771f8295d573dd20dbc7d2d0b31d2b49722ce00257f583b57428d2e4c558a9e"));
        assert(genesis.hashMerkleRoot == uint256S("0x096e69df96ded7cb6c75387b21ebfcc2d028b9409c611c564ae02e4c9fec1090"));
        ...
        checkpointData = (CCheckpointData){
            boost::assign::map_list_of
            ( 0, uint256S("0x5771f8295d573dd20dbc7d2d0b31d2b49722ce00257f583b57428d2e4c558a9e"))
        };
