...
const char * const BITCOIN_CONF_FILENAME = "bitesax.conf";
const char * const BITCOIN_PID_FILENAME = "bitesax.pid";
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Bitesax";
#else
    // Unix
